...
public class G_Triple {
	 ...
	 * [표현법]
	 * 조건식 ? 조건식이 true일경우 결과 값 : 조건식이 false일 경우 결과 값
	 * 
	 */
	public void method1() {
	...
	public void method3() {
		//사용자로부터 영문자 하나를 입력받아 대문자인지, 아닌지 판별 후 출력
		// 아스키코드표 활용
		
		Scanner sc = new Scanner(System.in);
		
		System.out.print("영문자 한 개만 입력: ");
	...
	public void method4() {
		// method1()의 내용보완
		// 사용자가 입력한 정수값이 [양수인지, 0인지, 음수인지] 3가지를 판별
	...
	public void method5() {
		...
		System.out.println("연산자 입력하세요(+ or -)");
		...
		int result2 = (op == '+' ? (num1+num2) : (num1-num2));
